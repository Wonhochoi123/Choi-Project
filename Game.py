...
class Game(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        bgm1 = SoundLoader.load('resources/sound effects/2018-04-02_-_Beautiful_Village_-_David_Fesliyan.mp3')
        ...
        def press_b(instance):
            ...
            if (result=='win')|(result=='lose'):
                ...
                winningpopup = Popup(title='Game ended.',
                                     content = Button(text='Close me!',on_press=reset,on_release=winningpopup_close),
                                     # Label(text=f'You {result}!'),
                                     size_hint=(1, 0.5), size=(400, 400),opacity=0.7)
